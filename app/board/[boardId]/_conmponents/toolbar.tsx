import ToolButton from "@/app/board/[boardId]/_conmponents/tool-button";
...
export const ToolbarSkeleton = () => {
  return (
    <div className="absolute top-[50%] -translate-y-[50%] left-2 flex flex-col gap-y-4 gb-white h-[360px] w-[52px] shadow-md" />
  );
};
